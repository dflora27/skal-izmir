...
export default async function BoardPage({ params }: { params: Promise<{ lang: 'tr' | 'en' | 'es' }> }) {
  ...
  const dict = await getDictionary(lang);
    ...
    const members = [
      { name: "Aydın TOKBAŞ", roleTr: "Başkan", roleEn: "President", phone: "+90 505 862 07 85", email: "president@skalizmir.com", photo: "/yonetim/yonetim_aydin-tokbas.jpg" },
      ...
      { name: "Gülçağ ÖZMERMER", roleTr: "Sponsorluk Geliştirme", roleEn: "Sponsorship Development", phone: "+90 532 571 41 84", email: "sponsorship@skalizmir.com", photo: "/yonetim/yonetim_gamze-gulcag-yeni-ozmermer.JPG" }
    ];
