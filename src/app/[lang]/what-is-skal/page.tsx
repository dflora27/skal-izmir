...
const PAGE_CONTENT = {
  tr: {
    ...
    historyP2: "2 yıl sonra, <strong>1934</strong> yılında, bu oluşum dostluk ve uluslararası bazda gelişmiş, <strong class=\"text-[#0A192F] italic\">\"Association Internationale des Skal Clubs\"</strong> formasyonunda uluslararası kimliğine kavuşmuştur. Sonraki yıllarda resmi adı kısaltılarak <strong>SKAL INTERNATIONAL</strong> şeklinde değişmiştir.",
    statCountry: "Ülke",
    statClub: "Kulüp",
    statMember: "Üye",
  ...
  es: {
    ...
    historyP2: "Dos años más tarde, en <strong>1934</strong>, la formación se desarrolló internacionalmente fortaleciendo la vinculación bajo un formato mundial conocido como la <strong class=\"text-[#0A192F] italic\">\"Association Internationale des Skal Clubs\"</strong>. Años más tarde se cambió y acortó a <strong>SKAL INTERNATIONAL</strong>.",
    statCountry: "Países",
    statClub: "Clubes",
    statMember: "Miembros",
