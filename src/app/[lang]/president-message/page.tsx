...
const PRESIDENT_CONTENT = {
  tr: {
    ...
    quote: "Vizyonumuz; Artık İzmir Skal kulübü bir markadır. İzmir'de turizm denince ilk akla gelmektedir. Bünyemizde barındırdığımız tüm Turizm STK'larımız ile birlikte güçlü bir aileyiz.",
  ...
  en: {
    ...
    quote: "Our Vision; Izmir Skal club is now a prominent brand. It is the first to come to mind when tourism is mentioned in Izmir. We are a strong family together with all the Tourism NGOs we harbor.",
  ...
  es: {
    ...
    quote: "Nuestra Visión; El club Skal de Esmirna es ahora una marca destacada. Es lo primero que viene a la mente cuando se menciona el turismo en Esmirna. Somos una familia fuerte junto con todas las ONG de Turismo que albergamos.",
